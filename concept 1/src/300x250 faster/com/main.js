...
function animate(){
    ...
    // connect ellipse
    .to(ellipse1, 0.5, {x:5, y:10, scale:1, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.5, {x:-1, y:6, scale:1.1, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.5, {x:2, y:-3, scale:.8, ease:Expo.easeIn},"conn-=.2")
    ...
    .from(logo_c_2x, 0.6, {x:-10, opacity:0,ease:Expo.easeIn},"-=.6")


    // copy animations
    .from(bg_2x, 1, {x:50, opacity:0,ease:Expo.easeIn},"bg-=.5")
    .from(c_2x, 1, {x:-50, opacity:0,ease:Expo.easeIn},"bg-=.2")
    ...
    // EF
    .from(new_bg_2x, .5, {opacity:0,ease:Power1.easeIn})
