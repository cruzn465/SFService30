...
function animate(){
    ...
    // F1 ELLIPSE ANIM:
    // ellipse grow
    .to(ellipse1, .5, {scale:.5,opacity:1, ease:Expo.easeOut},"ell_grow+=.1")
    .to(ellipse3, .5, {scale:.5,opacity:1, ease:Expo.easeOut},"ell_grow+=.2")
    .to(ellipse2, .5, {scale:.5,opacity:1, ease:Expo.easeOut},"ell_grow+=.3")

    // connect ellipse
    .to(ellipse1, 0.5, {x:7, y:8, scale:.69, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.5, {x:-6, y:-4, scale:.78, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.5, {x:5, y:-5, scale:.63, ease:Expo.easeIn},"conn-=.2")
