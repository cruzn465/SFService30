...
function animate(){
    ...
    // // connect ellipse
    .to(ellipse1, 0.5, {x:7, y:8, scale:1.2, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.5, {x:-3, y:4, scale:1.3, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.5, {x:4, y:-2, scale:1, ease:Expo.easeIn},"conn-=.2")
