...
function animate(){
    ...
    // connect ellipse
    .to(ellipse1, 0.5, {x:5, y:11, scale:1.3, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.5, {x:-13, y:1, scale:1.4, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.5, {x:5, y:-8, scale:1, ease:Expo.easeIn},"conn-=.2")
