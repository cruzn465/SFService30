...
function animate(){
    ...
    // connect ellipse
    .to(ellipse1, 0.5, {x:6, y:11, scale:1.3, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.5, {x:-11, y:1, scale:1.4, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.5, {x:7, y:-8, scale:1, ease:Expo.easeIn},"conn-=.2")
    ...
    // copy animations
    .staggerFrom([c_2x], 0.4, {x:-25, opacity:0,ease:Power3.easeIn},.3)
    .to([c_2x], 0.4, {x:2,opacity:0,ease:Power2.easeOut},"+=1.5")
    // F2
    .staggerFrom([c2_2x], 0.4, {x:-25, opacity:0,ease:Power3.easeIn},.3)
    .to([c2_2x], 0.4, {x:2,opacity:0,ease:Power2.easeOut},"+=2")
