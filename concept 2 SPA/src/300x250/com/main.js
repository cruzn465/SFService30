...
function animate(){
    ...
    // connect ellipse
    .to(ellipse1, 0.5, {x:6, y:10, scale:1, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.5, {x:0, y:6, scale:1.1, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.5, {x:3, y:-3, scale:.8, ease:Expo.easeIn},"conn-=.2")
