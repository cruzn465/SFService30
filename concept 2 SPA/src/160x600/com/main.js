...
function animate(){
    ...
    // connect ellipse
    .to(ellipse1, 0.5, {x:3, y:6, scale:1, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.5, {x:-3, y:-5, scale:1, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.5, {x:5, y:-11, scale:.8, ease:Expo.easeIn},"conn-=.2")
