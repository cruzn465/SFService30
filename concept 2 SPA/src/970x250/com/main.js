...
function animate(){
    ...
    // connect ellipse
    .to(ellipse1, 0.5, {x:11, y:15, scale:.9, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.5, {x:-9, y:2, scale:1, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.5, {x:5, y:-13, scale:.6, ease:Expo.easeIn},"conn-=.2")
